...
impl Checker<'_> {
	pub fn check_type_def_stmt(
		&mut self,
		type_def: &mut ast::TypeDefStmt,
	...
	pub fn check_struct_def(&mut self, type_def: &mut ast::TypeDefStmt) -> MessageResult<TypedValue> {
	...
	pub fn synthesise_alias(&mut self, type_def: &mut ast::TypeDefStmt) -> MessageResult<TypedValue> {
